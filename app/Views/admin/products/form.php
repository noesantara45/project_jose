            ...
            <form action="<?= base_url('admin/products/save') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group" style="flex: 1;">
                        ...
                        <select name="category_id" class="form-control" required>
                            ...
                            <option value="1" <?= isset($product) && $product['category_id'] == 1 ? 'selected' : '' ?>>
                                Elektronik</option>
                            <option value="2" <?= isset($product) && $product['category_id'] == 2 ? 'selected' : '' ?>>
                                Fashion Pria</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" class="form-control">
                            <option value="1" <?= isset($product) && $product['is_active'] == 1 ? 'selected' : '' ?>>
                                Active</option>
                            <option value="0" <?= isset($product) && $product['is_active'] == 0 ? 'selected' : '' ?>>
                                Inactive</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div style="margin-top: 10px;">
                        <small style="color: var(--text-light);">Gambar saat ini: <?= $product['image'] ?></small>
                    </div>
                    <?php endif; ?>
                </div>
