                ...
                <div class="card card-profile h-100">
                    <div class="profile-cover">
                        <div class="position-absolute top-0 end-0 p-3">
                            <span class="badge bg-white text-dark shadow-sm"><i
                    ...
                    <div class="card-body text-center pt-0 pb-4 px-4">
                        ...
                        <div class="d-flex justify-content-center gap-2 mb-4">
                            <div class="badge-member">
                                <i class="fas fa-calendar-alt"></i> Join:
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="address_main"
                                            class="form-control form-control-custom form-textarea" rows="3"
