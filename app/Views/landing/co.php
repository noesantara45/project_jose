                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <label class="card card-custom p-3 card-body-custom" style="cursor: pointer;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="fw-bold mb-0"><i
                                                    class="fas fa-wallet me-2 text-success"></i>E-Wallet
                                ...
                                <label class="card card-custom p-3 card-body-custom" style="cursor: pointer;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="fw-bold mb-0"><i
                                                    class="fas fa-hand-holding-usd me-2 text-warning"></i>Cash On
                                                Delivery
                                                (COD)</h6>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-custom border-0 shadow-sm sticky-summary">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <h4 class="fw-bold text-primary mb-0">Rp <?= number_format($total, 0, ',', '.') ?>
                                    </h4>
                                </div>
